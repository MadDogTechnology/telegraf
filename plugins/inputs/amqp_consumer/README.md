...
Message payload should be formatted in one of the [Telegraf Data Formats](https://github.com/MadDogTechnology/telegraf/blob/master/docs/DATA_FORMATS_INPUT.md).
