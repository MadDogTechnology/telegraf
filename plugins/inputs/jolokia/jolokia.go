...
const sampleConfig = `
  ...
  # jolokia2 plugin
  # see https://github.com/MadDogTechnology/telegraf/tree/master/plugins/inputs/jolokia2
...
func (j *Jolokia) Gather(acc telegraf.Accumulator) error {
	...
	if j.jClient == nil {
		log.Println("W! DEPRECATED: the jolokia plugin has been deprecated " +
			...
			"(https://github.com/MadDogTechnology/telegraf/tree/master/plugins/inputs/jolokia2)")
